---
title: Outline-Stress-Test
date: 2026-06-24
link: https://silverbullet.md/Outline%20Stress%20Test
tags: 
  - md-test
---
...
* A [[Playground]] wiki link embedded
* A regular [external link](https://example.com) in the middle of a line
* Mix: **bold**, *italic*, `code`, [[Playground]], [ext](http://x) — does the wrap stay aligned?

# Task states
* [ ] Open task
* [x] Completed task
* [ ] Task with **bold** and a [[Playground]] inside
* [ ] Long task with formatting: **bold**, *italic*, `code`, [[Playground]] — verify wrapped lines hang correctly
...
A line with [[Playground]] in the middle and `code` and **bold** — chip should not add box width.
